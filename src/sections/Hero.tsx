  ...
  return (
    ...
    >
      ...
      <div
       ...
       bg-purple-500 rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[radial-gradient(50%_50%_at_16.8%_18.3%,white,rgb(184,148,255)_37.7%,rgb(24,0,66))] shadow-[-20px_-20px_50px_rgb(255,255,255,.5),-20px_-20px_80px_rgb(255,255,255,.1),0px_0px_50px_rgb(140,69,255)]"
      ></div>
      ...
      >
        ...
        <div className="absolute h-2 w-2 bg-white rounded-full left-1/2 -translate-x-1/2 -translate-y-1/2"></div>
      ...
      <motion.div
        ...
        className="absolute h-[544px] w-[544px] md:h-[980px] md:w-[980px] border border-white/20 rounded-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-20"
      >
        <div className="absolute h-2 w-2 bg-white rounded-full top-1/2 -translate-x-1/2 -translate-y-1/2"></div>
      ...
      <div className="container relative mt-16">
        ...
        font-semibold tracking-tighter bg-[radial-gradient(100%_100%_at_top_left,white,white,rgba(74,32,138,0.7))] bg-white text-transparent bg-clip-text text-center"
        >
          AI SEO
        </h1>
